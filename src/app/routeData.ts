 ...
 *
 * Currently this handles connect-dialog submissions. Successful connections
 * redirect to the default route; recoverable failures return typed action data
 * for the dialog instead of throwing into the root error boundary.
 */
